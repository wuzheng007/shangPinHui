<template>
  <el-form ref="form" :model="form" :rules="rules" label-width="6em">
    <el-form-item label="SPU名称" prop="spuName">
      <el-input v-model="form.spuName" placeholder="SPU名称" />
    </el-form-item>
    ...
    <el-form-item label="SPU描述" prop="description">
      <el-input v-model="form.description" type="textarea" placeholder="请输入SPU描述" rows="4" />
    </el-form-item>
    <!-- SPU图片 -->
    ...
    <el-form-item label="销售属性">
      <el-select
        v-model="selectSaleAttrStr"
        :placeholder="`还有${unSelectBaseSaleAttrList.length}项未选择`"
        clearable
        filterable
      >
        <el-option
          v-for="item in unSelectBaseSaleAttrList"
          :key="item.id"
          :label="item.name"
    ...
    <el-form-item label="">
      <el-table :data="spuSaleAttrList" border stripe>
        ...
        <el-table-column label="属性名" prop="saleAttrName" align="center" width="120" />
        ...
        <el-table-column label="操作" prop="" align="center" width="100">
          <template v-slot="{ row, $index }">
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDeleteSaleAttr($index)" />
          </template>
        </el-table-column>
      </el-table>
    </el-form-item>
